export const config = {
  ...
  PREFERENCES_DESCRIPTION:
    "Please submit your preferences by Wednesday 1/31 at 1AM. You must either select a unique rank for each group or select 'Do not rank.' Selecting 'Do not rank' for a group means that you do not want to continue with that group.",
};

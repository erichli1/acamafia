export const config = {
  ...
  PREFERENCES_DESCRIPTION:
    "Please submit your preferences by January 23rd, 11:59PM. You must either select a unique rank for each group or select 'Do not rank.' Selecting 'Do not rank' for a group means that you do not want to continue with that group.",
};
